...
if __name__ == "__main__":
    ...
    cell_response_subset = neural_data.get_cell_responses
    ...
    if testing == True:
        for model_layer in tqdm(srp_feature_maps):
            ...
            if not os.path.exists(results_filepath):
                ...
                scores = neural_regression(X, y, score_type = ['pearson_r', 'explained_variance'])
        
                scoresheet_list = []
                for score_type in scores:
                    scoresheet_list.append(pd.DataFrame({'cell_specimen_id': cell_response_subset.index,
